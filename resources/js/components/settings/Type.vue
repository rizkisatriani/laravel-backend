        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Master Type</h1>
                        <p><b>Data Type</b> seperti Jenis data type merupakan kategori kedua dari item barang <br> Cth : Barang fast moving/Barang slow moving dll.</p>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Type</h3>
...
export default {
    ...
    methods: {forceRerender() {
        ...
        showdata() {
            ...
            axios.get("api/showtype", { headers })
                .then(function(response) {
                    var status = "";
